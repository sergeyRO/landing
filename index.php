        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <!--RU-->
                    <ul class="nav navbar-nav menu_nav ml-auto" lang="ru">
                    ...
                    <!--DE-->
                    <ul class="nav navbar-nav menu_nav ml-auto" lang="de">
                    ...
                    <!--EN-->
                    <ul class="nav navbar-nav menu_nav ml-auto" lang="en">
        ...
        <div class="container">
            <div class="row banner_content" lang="ru">
                <div class="col-lg-9">
                    ...
                    <div class="price_footer" align="center">
                        <a class="main_btn2" data-toggle="modal">Заказать</a>
                    </div>
                </div>
                <div class="col-lg-33">
            ...
            <div class="row banner_content" lang="de">
                <div class="col-lg-9">
                    ...
                    <div class="price_footer" align="center">
                        <a class="main_btn2" data-toggle="modal">Bestellen</a>
                    </div>
                </div>
                <div class="col-lg-33">
                    <div class="banner_map_img" style="width: 130%">
            ...
            <div class="row banner_content" lang="en">
                <div class="col-lg-9">
                    ...
                    <div class="price_footer" align="center">
                        <a class="main_btn2" data-toggle="modal">To order a site</a>
                    </div>
                </div>
                <div class="col-lg-33">
                    <div class="banner_map_img" style="width: 130%">
        ...
        <div class="feature_inner row">
            <div class="col-lg-3 col-md-6">
                <div class="feature_item" align="center">
                    <div style="height: 260px"><svg class="svgicon" id="svg27" style="fill: rgb(38, 0, 118);width: 75px" preserveAspectRatio="xMidYMid meet"
            ...
            <div class="col-lg-3 col-md-6">
                <div class="feature_item" align="center">
                    ...
                    <h4>Building a website from scratch</h4>
                        <p>Business card sites, e-commerce sites, Internet portals, social platforms, wiki sites, landing pages</p></div>
                    <div><a class="main_btn2" data-toggle="modal">To order a site</a></div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="feature_item" align="center">
                    ...
                    <h4>Effective contextual advertising</h4>
                        <p>Creation, setup and maintenance of effective advertising campaigns in Google Ads and Yandex Direct</p></div>
                    <div><a class="main_btn2" data-toggle="modal">To order a site</a></div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="feature_item" align="center">
                    ...
                    <h4>Social media marketing</h4>
                        <p>Creation, setup and maintenance of effective advertising campaigns in social networks.</p></div>
                    <div><a class="main_btn2" data-toggle="modal">To order a site</a></div>
                </div>
            </div>
        </div>
        ...
        <div class="feature_inner row">
            <div class="col-lg-3 col-md-6">
                <div class="feature_item" align="center">
                    ...
                    <div><a class="main_btn2" data-toggle="modal">Bestellen</a></div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="feature_item" align="center">
            ...
            <div class="col-lg-5 offset-lg-1" style="margin-left: 0%;">
                <div class="interior_text xxx">
                    ...
                    <div id="carouselExampleIndicators" class="carousel_slide" data-ride="carousel">
                        <div class="carousel-inner" style="height: 185px;">
                        ...
                        <div align="center"><a class="main_btn2" data-toggle="modal">Заказать</a></div>
                    </div>
            ...
            <div class="col-lg-5 offset-lg-1" style="margin-left: 0%;">
                <div class="interior_text xxx">
                    ...
                    <div id="carouselExampleIndicators" class="carousel_slide" data-ride="carousel">
                        ...
                        <div align="center"><a class="main_btn2" data-toggle="modal">To order a site</a></div>
                    </div>
            ...
            <div class="col-lg-5 offset-lg-1" style="margin-left: 0%;">
                <div class="interior_text xxx">
                    ...
                    <div id="carouselExampleIndicators" class="carousel_slide" data-ride="carousel">
                        ...
                        <div align="center"><a class="main_btn2" data-toggle="modal">Bestellen</a></div>
                    </div>
...
<section lang="ru" class="price_area p_120" id="price">
    ...
    eapps-pricing-table-column-features-item-with-icon">
                    ...
                    <div class="price_footer">
                        <a class="main_btn2" data-toggle="modal" onclick="">Начать сейчас</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
    ...
    <div class="footer_t" >
     ...
     <div class="footer_t">
        ...
        <div class="social facebook">
            <a href="https://m.facebook.com/Nordpromotion-111904091579803/?paipv=1" target="_blank"" target="_blank">
